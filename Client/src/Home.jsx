...
const HomePage = () => {
  ...
  const topicsWithLogos = [
    { name: "Topic 1", logo: logo },
    { name: "Topic 2", logo: logo },
    { name: "Topic 3", logo: logo },
    { name: "Topic 4", logo: logo },
    { name: "Topic 5", logo: logo },
    { name: "Topic 6", logo: logo },
    { name: "Topic 7", logo: logo },
    { name: "Topic 8", logo: logo },
    { name: "Topic 9", logo: logo },
    { name: "Topic 10", logo: logo },
